<div class="instructor-profile-left-part bg-white">
    <nav class="account-page-menu">
        <ul>
            ...
            {{-- Libros digitales (Solo lectura) - enlace externo, abre en nueva pestaña --}}
            <li>
                <a href="https://editorialsaber.com.mx/libros-digitales-plataforma/"
                   target="_blank" rel="noopener noreferrer">
                    <span class="iconify mr-15" data-icon="mdi:book-open-page-variant-outline"></span>
                    {{ __('Digital books (Read only)') }}
                </a>
            </li>
