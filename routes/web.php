...
Route::match(['GET','POST'], 'verify-certificate', [CertificateVerifyController::class, 'verifyCertificate'])->name('verify_certificate');
Route::match(['GET','POST'],'/payment-notify/{id}', [PaymentApiController::class, 'paymentNotifier'])->name('paymentNotify');
Route::match(['GET','POST'],'/payment-notify-subscription/{id}', [PaymentApiController::class, 'paymentSubscriptionNotifier'])->name('paymentNotify.subscription');
Route::match(['GET','POST'],'/payment-notify-wallet-recharge/{id}', [PaymentApiController::class, 'paymentWalletRechargeNotifier'])->name('paymentNotify.wallet_recharge');
Route::match(['GET','POST'],'payment-cancel/{id}', [PaymentApiController::class, 'paymentCancel'])->name('paymentCancel');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('duplicate-course/{courseId}/to-instructor/{instructorId}', [\App\Http\Controllers\Organization\CourseController::class, 'duplicateForInstructor'])->name('courses.duplicate');
